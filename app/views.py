...
def atualiza():
    r = request.args
    print("Recebido na rota Atualiza",r)   
 
    if "rele1" in r:
        print("reconheceu rele1 na chamada")
        rele1 = rele.get_status1()
        dados = {"rele1" : rele1}
        print("dados a enviar",dados)

    if "rele2"in r:
        rele2 = rele.get_status2()
        dados = {"rele2":rele2}

    if "rele3"in r:
        rele3 = rele.get_status3()
        dados = {"rele3":rele3}

    if "rele4"in r:
        rele4 = rele.get_status4()
        dados = {"rele4":rele4}

    if "rele5"in r:
        rele5 = rele.get_status5()
        dados = {"rele5":rele5}

    if "rele6"in r:
        rele6 = rele.get_status6()
        dados = {"rele6":rele6}

    if "rele7"in r:
        rele7 = rele.get_status7()    
        dados = {"rele7":rele7}

    if "rele8"in r:
        rele8 = rele.get_status8()    
        dados = {"rele8":rele8}

    if "rele9"in r:
        rele9 = rele.get_status9()    
        dados = {"rele9":rele9}

    if "rele10"in r:
        rele10 = rele.get_status10()    
        dados = {"rele10":rele10}

    if "rele11"in r:
        rele11 = rele.get_status11()    
        dados = {"rele11":rele11}

    if "rele12"in r:
        rele12 = rele.get_status12()    
        dados = {"rele12":rele12}

    if "rele13"in r:
        rele13 = rele.get_status13()
        dados = {"rele13":rele13}    
    
    if "todos" in r:
        print("Atualizando todos os status dos reles")
        rele1 = rele.get_status1()
        rele2 = rele.get_status2()
        rele3 = rele.get_status3()
        rele4 = rele.get_status4()
